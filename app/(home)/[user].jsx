import {
  ...
  const user = React.memo(() => {
    ...
    const addAttendanceStatus = useSelector(state=> state.addAttendance.status)
    const addAttendanceError = useSelector(state=> state.addAttendance.error)
    ...
    const submitAttendance = () => {
        ...
        if (addAttendanceStatus === 'loading') {
          Alert.alert(`Attendance submitting...`);
        }
        if (addAttendanceStatus === 'succeeded') {
          Alert.alert(`Attendance marked ${attendanceStatus} for ${params?.name}`);
        }
        if (addAttendanceStatus === 'failed') {
          Alert.alert(`Attendance submitting failed ${addAttendanceError}`);
        }
    };
    return (
